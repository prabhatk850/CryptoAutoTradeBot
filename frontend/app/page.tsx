      ...
      <div className="pl-14 sm:pl-16">
        ...
        <main className="max-w-[1500px] mx-auto px-3 sm:px-6 lg:px-8 py-6 space-y-8">
          ...
          <section id="overview" className="space-y-4 scroll-mt-20">
            {/* Narrowed so it hugs its content instead of stretching full-width */}
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <StatCard label="Realized PnL" value={pnl ? `$${pnl.realized_pnl}` : "—"} sub={`unrealized $${pnl?.unrealized_pnl ?? 0}`} color="text-blue-400" />
            </div>
          </section>

          <section className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            <div className="lg:col-span-3 bg-[#161b22] border border-[#30363d] rounded-xl p-4 space-y-3">
              <ChartControls
            ...
            <div className="lg:col-span-1" id="settings">
              <NewsPanel />
            </div>
          </section>
