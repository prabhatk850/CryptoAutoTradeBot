...
from bot.indicators import calc_ema, calc_rsi, calc_macd
...
def run_backtest(candles_entry: list[dict], candles_trend: list[dict],
                 rr: float = None, atr_k: float = None) -> dict:
    ...
    # map each entry bar to the most recent completed trend (1h) bar's bias
